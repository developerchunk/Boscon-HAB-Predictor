...
Burst:                                                                  D(z) ≥ D_burst (manufacturer's nominal × factor)`}</pre>
    ...
    <p>The bundled climatology is for the Pune region and the Jejuri pad. For any other pad the Climatology tab downloads the Open-Meteo GFS archive at the pad, one request per calendar month (about 350 kB and 3–17 s each, measured 2026-09-22), stored raw in this browser so any months, date window, years or launch hour can be used offline afterwards; a progress bar shows months, bytes, elapsed and remaining time, Cancel stops it, and Download resumes it (stored months are skipped). The full archive from April 2021 is 66 months, about 23 MB and about 12 minutes at the measured 11 s per month. The complete Solapur-pad archive (April 2021 – September 2026, 66 months, 5.6 MB compressed, fetched 2026-09-22) is bundled with the site and installs itself the first time the tab opens at that pad, with no Open-Meteo request. The Storage tab lists everything kept in the browser (saved predictions, archives and their months, settings, this page's in-memory caches) with single, multi-select and delete-all, and can export an archive as a portable file and import one.</p>
